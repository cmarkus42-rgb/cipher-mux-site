const features = {
  ...
  sections: [
    ...
    },
    {
      ...
      lead: 'If you prefer speaking over typing, the local Whisper.cpp integration offers a great alternative \u2013 entirely without cloud dependencies. The system automatically detects pauses in speech. For the text-to-speech function, the system utilizes Piper or the familiar macOS system voice. New: the Cipher Adult voice bundle provides a dedicated German adult voice for natural-sounding speech output.',
    },
    {
      num: '08',
    ...
    },
    {
      ...
      lead: 'A local HTTP server provides 62 tools across 10 categories. These enable agents to handle session management or communicate directly with one another via a message bus.',
    },
    {
      num: '10',
